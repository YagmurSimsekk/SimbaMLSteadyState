from simba_ml.example_problems import sird as problem_module
...
def test_derivate():
    kinetic_parameters = {"beta": 0.2, "gamma": 0.2, "delta": 0.2, "epsilon": 0.1}

    y = [1000, 800, 200, 0]
    assert problem_module.sm.deriv(0, y, kinetic_parameters) == (-60, -240, 140, 160)
