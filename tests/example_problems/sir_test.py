from simba_ml.example_problems import sir as problem_module
...
def test_derivate():
    kinetic_parameters = {"beta": 0.5, "gamma": 0.5}

    y = [1000, 1000, 0]
    assert problem_module.sm.deriv(0, y, kinetic_parameters) == (-250, -250, 500)
